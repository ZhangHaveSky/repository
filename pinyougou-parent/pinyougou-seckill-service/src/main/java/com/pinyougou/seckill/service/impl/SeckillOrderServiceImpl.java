...
public class SeckillOrderServiceImpl implements SeckillOrderService {
    ...
    public void submitOrder(Long seckillId, String userId) {
        ...
        if(seckillGoods.getStockCount()==0){
            tbSeckillGoods.updateByPrimaryKey(seckillGoods);	//更新数据库
    ...
    @Autowired
    private TbSeckillGoodsMapper tbSeckillGoods;
    ...
    public void deleteOrderFromRedis(String userId, Long orderId) {
        ...
        if (seckillOrder != null) {
            ...
            if (seckillGoods != null) {
                ...
                //属性要设置。。。。省略
                TbSeckillGoods tbSeckillGoods = this.tbSeckillGoods.selectByPrimaryKey(seckillOrder.getSeckillId());
                ...
                seckillGoods.setCheckTime(tbSeckillGoods.getCheckTime());
